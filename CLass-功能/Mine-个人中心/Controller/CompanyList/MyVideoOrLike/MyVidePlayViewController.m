...
@interface MyVidePlayViewController ()<TXVodPlayListener,UIGestureRecognizerDelegate>{
      TXVodPlayer *        player;
...
@implementation MyVidePlayViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    NSLog(@"url==%@",self.model.url);
    self.view.backgroundColor = [UIColor blackColor];
    self.playerView=[[MyVideoPlayerView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
    [self.view addSubview:self.playerView];
    self.playerView.userInteractionEnabled=YES;
    self.playerView.myModel=self.model;
